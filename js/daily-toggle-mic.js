...
class DailyToggleMic extends HTMLButtonElement {
  ...
  constructor() {
    ...
    this.addEventListener('click', e => {
      callObject.setLocalAudio(this.muted);
      this.muted ? this.textContent = "Mute" : this.textContent = "Unmute";
      this.muted = !this.muted;
    });
  }
}

window.customElements.define('daily-toggle-mic', DailyToggleMic, { extends: 'button' });
